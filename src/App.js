...
class App extends Component {
  ...
  renderResult() {
    return (
      <Popup modal trigger={<div className="endPage"><h2>Game Completed!</h2><button className="showResult">Show Result</button></div>}>
        {close => <Result quizResult={this.state.allQuestions} answers={this.state.selectedAnswers} close={close} />}
      </Popup>
